...
export default function Decomposer({editpopup}){
    return(
            ...
            <div className="ajoutercontainer">
                <div className="leftajoutercompte">
                     ...
                     <div className="formulairecompte">
                         <h1 className="nomprenomcompte">Nombre de Phase</h1>
                         <input placeholder="Nombre de Phase" class="inputcompte" name="text" type="text"/>
                     </div>
                     <div className="formulairecompte">
                         <h1 className="nomprenomcompte">Nom de Chaque Phases</h1>
                         <select placeholder="Mot de Passe" class="inputcompte" name="text" type="text" list="myliste">
                              <option value="directeur generale">Introduction</option>
                     ...
                     </div><div className="flexcalender2">
                ...
                <div className="rightajoutercompte">
                        <h1 className="ajoutercomptetitle">Decomposer le Projet en Phases</h1>
